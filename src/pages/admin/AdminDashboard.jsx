    ...
    return (
        <div>
            ...
            <div className="px-5 mt-5 mb-5 top">
                <div className="py-5 border border-pink-100 rounded-lg  bg-pink-50">
                    <h1 className="text-2xl font-bold text-center text-pink-500 ">Admin Dashboard</h1>
                </div>
            </div>
                    ...
                    <Tabs>
                        <TabList className="flex flex-wrap justify-center -m-4 text-center">
                            ...
                            <Tab className="w-full p-4 cursor-pointer md:w-1/3 sm:w-1/2">
                                <div className="px-4 py-3 border border-pink-100  bg-pink-50 hover:bg-pink-100 rounded-xl" >
                                    <div className="inline-block w-12 h-12 mb-3 text-pink-500" >
                                        <svg
                                    ...
                                    <h2 className="text-3xl font-medium text-pink-400 title-font fonts1" >{getAllProduct.length}</h2>
                            ...
                            <Tab className="w-full p-4 cursor-pointer md:w-1/4 sm:w-1/2">
                                <div className="px-4 py-3 border border-pink-100  bg-pink-50 hover:bg-pink-100 rounded-xl" >
                                    ...
                                    <h2 className="text-3xl font-medium text-pink-400 title-font fonts1" >{getAllOrder.length}</h2>
