                        ...
                        {getAllProduct.map((item, index) => {
                            ...
                            return (
                                <tr key={index} className="text-pink-300">
                                    ...
                                    <td onClick={()=> navigate(`/updateproduct/${id}`)} className="h-12 px-6 text-green-500 transition duration-300 border-t border-l border-pink-100 cursor-pointer text-md first:border-l-0 stroke-slate-500 text-slate-500 ">
                                        Edit
                                    </td>
                                    <td onClick={()=> deleteProduct(id)} className="h-12 px-6 text-red-500 transition duration-300 border-t border-l border-pink-100 cursor-pointer text-md first:border-l-0 stroke-slate-500 text-slate-500 ">
                                        Delete
                                    </td>
                                </tr>
                            )
